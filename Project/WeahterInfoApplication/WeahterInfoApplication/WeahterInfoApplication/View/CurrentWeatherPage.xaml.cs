...
using WeahterInfoApplication.Helper;
using WeahterInfoApplication.Models;
using Xamarin.Essentials;
using Xamarin.Forms;
using Xamarin.Forms.Xaml;

namespace WeahterInfoApplication.View
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        private async void GetWeatherInfo()
        {
           ...
           var url = $"http://api.openweathermap.org/data/2.5/weather?q={Location}&appid=      &units=metric";
            var result = await ApiCaller.Get(url);
